...
exports.getUserMetrics = async (req, res) => {
  try {
    ...
    console.log(`Fetching fitness metrics for user ID: ${userId}`);
    ...
    console.log(`Successfully fetched fitness metrics for user ID: ${userId}`);
    ...
    res.status(500).json({ message: 'Failed to get fitness metrics', error: error.message });
  }
};
...
exports.addWeightEntry = async (req, res) => {
  try {
    ...
    console.log(`Adding weight entry for user ID: ${userId}`, { value, date });
    ...
    console.log(`Successfully added weight entry for user ID: ${userId}`, { id: result.insertId });
...
exports.addBodyFatEntry = async (req, res) => {
  try {
    ...
    console.log(`Adding body fat entry for user ID: ${userId}`, { value, date });
    ...
    console.log(`Successfully added body fat entry for user ID: ${userId}`, { id: result.insertId });
    ...
    res.status(500).json({ message: 'Failed to add body fat entry', error: error.message });
  }
};
...
exports.addWaterIntake = async (req, res) => {
  try {
    ...
    console.log(`Adding water intake for user ID: ${userId}`, { value, date });
    ...
    if (existingEntries.length > 0) {
      ...
      console.log(`Updated water intake for user ID: ${userId}`, { id: existingEntries[0].id, newValue });
    ...
    console.log(`Successfully added water intake for user ID: ${userId}`, { id: result.insertId });
    ...
    res.status(500).json({ message: 'Failed to add water intake', error: error.message });
  }
};
...
exports.addWorkoutLog = async (req, res) => {
  try {
    ...
    console.log(`Adding workout log for user ID: ${userId}`, { date, duration, exercises: exercises?.length });
    ...
    console.log(`Successfully added workout log for user ID: ${userId}`, { id: workoutLogId });
    ...
    res.status(500).json({ message: 'Failed to add workout log', error: error.message });
  }
};
...
exports.addGoal = async (req, res) => {
  try {
    ...
    console.log(`Adding fitness goal for user ID: ${userId}`, { type, target, deadline });
    ...
    console.log(`Successfully added fitness goal for user ID: ${userId}`, { id: result.insertId });
    ...
    res.status(500).json({ message: 'Failed to add fitness goal', error: error.message });
  }
};
...
exports.deleteWorkoutLog = async (req, res) => {
  try {
    ...
    console.log(`Deleting workout log for user ID: ${userId}`, { logId });
    ...
    console.log(`Successfully deleted workout log for user ID: ${userId}`, { logId });
    ...
    res.status(500).json({ message: 'Failed to delete workout log', error: error.message });
  }
};
...
exports.deleteGoal = async (req, res) => {
  try {
    ...
    console.log(`Deleting fitness goal for user ID: ${userId}`, { goalId });
    ...
    console.log(`Successfully deleted fitness goal for user ID: ${userId}`, { goalId });
...
exports.updateGoalProgress = async (req, res) => {
  try {
    ...
    console.log(`Updating goal progress for user ID: ${userId}`, { goalId, progress });
    ...
    console.log(`Successfully updated goal progress for user ID: ${userId}`, { goalId, progress });
...
exports.getFitnessStats = async (req, res) => {
  try {
    ...
    console.log(`Getting fitness stats for user ID: ${userId}`);
    ...
    console.log(`Successfully retrieved fitness stats for user ID: ${userId}`);
    ...
    res.status(500).json({ message: 'Failed to calculate fitness stats', error: error.message });
  }
};